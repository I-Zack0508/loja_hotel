...
export default function Footer() {
    return (
        <footer className={estilos.footer_contaienr}>

            <div className={estilos.logo_part}>
                <picture className={estilos.logo_img}>
                    <img src='./logo.jpg' />
                </picture>
                <p>Hotel é Trivago, melhor sistema de hospedagem, econômico e simples</p>
            </div>

            <div className={estilos.coisas}>
                <h3>SOBRE</h3>
                <p>Como funciona</p>
                <p>Faturado</p>
                <p>Parceiros</p>
